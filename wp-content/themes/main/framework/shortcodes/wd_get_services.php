...
if (!function_exists('tvlgiao_wpdance_service_gird_list_function')) {
	function tvlgiao_wpdance_service_gird_list_function($atts) {
...
add_shortcode('tvlgiao_wpdance_service_gird_list', 'tvlgiao_wpdance_service_gird_list_function');
?>