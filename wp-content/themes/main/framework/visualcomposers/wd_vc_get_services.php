<?php
	...
	$categories = 	get_terms( 'category-service', 
								array('hide_empty' 	=> 0)
							 );
	...
	vc_map(array(
			"name"				=> esc_html__("Service Gird/List",'wpdance'),
			"base"				=> 'tvlgiao_wpdance_service_gird_list',
			'description' 		=> esc_html__("Service Gird/List", 'wpdance'),
			...
			"params"=>array(	
				...
				array(
					'type'			=> 'textfield'
					,'heading' 		=> esc_html__( 'Number of services', 'wpdance' )
					,'param_name' 	=> 'number_service'
					,'admin_label' 	=> true
					,'value' 		=> '12'
				),
				array(
